...
RUN apt update && apt install -y openssl libapr1-dev autoconf vim xmlstarlet gradle gnupg zip unzip software-properties-common
RUN curl -fsSL https://download.docker.com/linux/ubuntu/gpg | apt-key add - && apt update && \ 
